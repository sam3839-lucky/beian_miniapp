...
- Tests live under `tests/` and use Node.js's built-in test runner.
- Add or update tests for new functions, bug fixes, error handling, and both sides of conditional branches.
- Never commit changes that make the existing test suite fail.
